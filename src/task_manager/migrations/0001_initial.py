# Generated by Django 5.2.12 on 2026-03-24 06:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'Created'), ('started', 'Started'), ('completed', 'Completed'), ('canceled', 'Canceled'), ('failed', 'Failed')], default='created', max_length=20, verbose_name='Статус')),
